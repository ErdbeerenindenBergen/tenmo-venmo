...
4. **[COMPLETE]** As an authenticated user of the system, I need to be able to *send* a transfer of a specific amount of TE Bucks to a registered user.
   ...
   3. **[What does it mean that the transfer includes user IDs? We may have to address this.]** A transfer includes the User IDs of the from and to users and the amount of TE Bucks.
...
7. **[COMPLETE]** As an authenticated user of the system, I need to be able to *request* a transfer of a specific amount of TE Bucks from another registered user.
   ...
   4. **[I'm similarly confused as to above. I think they currently include account IDs. But we could probably change this.]** A transfer 
